defmodule InstinctApi.Models.Companies.Post do
  use Ecto.Schema
  import Ecto.Changeset
  # alias InstinctApiWeb.Graphql.Types.Custom.JobType
  ...
  schema "posts" do
    ...
    belongs_to :company, InstinctApi.Models.Companies.Company
