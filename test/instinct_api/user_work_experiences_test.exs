defmodule InstinctApi.UserWorkExperiencesTest do
  use InstinctApi.DataCase

  alias InstinctApi.UserWorkExperiences

  describe "user_work_experiences" do
    alias InstinctApi.UserWorkExperiences.UserWorkExperience
